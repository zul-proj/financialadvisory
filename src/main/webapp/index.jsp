...
<html lang="en">
<head>
    <title>CashWise - Cashflow Tracking & Advisory</title>
                ...
                <li class="nav-item">
                    <c:choose>
                        <c:when test="${not empty sessionScope.user}">
                            <a class="btn btn-primary rounded-pill px-4" href="dashboard.jsp">
                                Dashboard
                            </a>
                        </c:when>

                        <c:otherwise>
                            <a class="btn btn-primary rounded-pill px-4" href="login.jsp">
                                Login
                            </a>
                        </c:otherwise>
                    </c:choose>
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7">
                ...
                <p class="lead text-secondary mb-4">
                    CashWise helps companies record income and expenses, monitor financial health,
                    analyze cashflow trends, and receive advisory suggestions based on business performance.
                </p>

                <div class="d-flex flex-wrap gap-3">
                    <a href="login.jsp" class="btn btn-primary btn-lg rounded-pill px-4">
                        Get Started
                    </a>

                    <a href="#features" class="btn btn-outline-primary btn-lg rounded-pill px-4">
                        View Features
                    </a>
                </div>
            </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="bg-light rounded-4 p-3 mb-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <strong class="text-success">RM 9,300.00</strong>
                            </div>
                        </div>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-8">
                ...
                <p class="text-secondary">
                    Many businesses still depend on spreadsheets or manual records, which can cause
                    errors, poor tracking, and delays in financial decision-making. CashWise provides
                    a cleaner way to manage company cashflow in one system.
                </p>
...
<section class="py-5">
    <div class="container">
        <div class="bg-primary text-white text-center rounded-5 p-5">
            ...
            <p class="mb-4">
                Manage transactions, analyze financial health, and improve business decision-making in one platform.
            </p>
...
<footer class="py-4 bg-white border-top">
    <div class="container text-center text-secondary">
        <small>© 2026 CashWise. Company Cashflow Tracking and Advisory System.</small>
    </div>
</footer>
