...
<head>
    <meta charset="UTF-8">
    <title>CashWise - Dashboard</title>
...
<div class="container-fluid">
    <div class="row min-vh-100">
        ...
        <!-- Sidebar -->
        <aside class="col-12 col-lg-2 bg-primary text-white p-4">
            <h4 class="fw-bold mb-4">Hazrel <3 Zul</h4>

            <div class="nav flex-column nav-pills gap-2">
                <a class="nav-link active text-white bg-info rounded-3" href="dashboard.jsp">
                ...
                <a class="nav-link text-white rounded-3" href="#">
                    <i class="bi bi-receipt me-2"></i> Invoice Upload
                </a>
