			...
			<aside class="col-12 col-lg-2 text-white p-4"
				...
				<div class="nav flex-column nav-pills gap-2">
					...
					<a class="nav-link active text-white bg-success rounded-3"
						href="financialmanager-settings.jsp">
				...
				<div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
					<div>
						...
						<p class="text-secondary mb-0">
							Manage your Financial Manager profile and notification settings.
						</p>
					</div>
						...
						<div class="card border-0 shadow-sm rounded-4 h-100">
							<div class="card-body p-4 text-center">
								<div
									...
									style="width: 92px; height: 92px; background-color: #0F766E;">
									<i class="bi bi-person-check fs-1"></i>
								</div>
								<h5 class="fw-bold mb-1">Abu Bakar</h5>
								<p class="text-secondary mb-3">Financial Manager</p>
							...
							<div class="card border-0 shadow-sm rounded-4 mb-4">
								<div class="card-body p-4">
									<div class="d-flex justify-content-between align-items-center mb-3">
										...
										<span class="badge text-bg-success rounded-pill">Finance Profile</span>
									</div>
									...
									<div class="row g-3">
										<div class="col-md-6">
											...
											<input type="text" class="form-control rounded-3"
												name="fullName" value="Abu Bakar">
										</div>
										<div class="col-md-6">
											<label class="form-label">Email Address</label>
											<input type="email" class="form-control rounded-3"
												name="email" value="abu@example.com">
										</div>
										<div class="col-md-6">
										...
										<div class="col-12">
											<div class="form-check form-switch">
												<input class="form-check-input" type="checkbox"
													name="statementAlerts" id="statementAlerts" checked>
												<label class="form-check-label" for="statementAlerts">
													Receive company statement and advisory alerts
												</label>
											</div>
										</div>
