			...
			<aside class="col-12 col-lg-2 text-white p-4"
				...
				<div class="nav flex-column nav-pills gap-2">
					...
					<a class="nav-link active text-white rounded-3"
						style="background-color: #084298;" href="staff-user-info.jsp">
				...
				<div
					...
					<div>
						...
						<p class="text-secondary mb-0">
							View and update your staff profile, contact details, and password.
						</p>
					</div>
					...
					<div class="col-lg-4">
						<div class="card border-0 shadow-sm rounded-4 h-100">
							<div class="card-body p-4 text-center">
								...
								<h5 class="fw-bold mb-1">Siti Aminah</h5>
								<p class="text-secondary mb-3">Department Staff</p>
						...
						<div class="card border-0 shadow-sm rounded-4">
							<div class="card-body p-4">
								<div class="d-flex justify-content-between align-items-center mb-3">
									...
									<span class="badge text-bg-primary rounded-pill">Staff Profile</span>
								</div>
									...
									<div class="row g-3">
										<div class="col-md-6">
											...
											<input type="text" class="form-control rounded-3"
												name="fullName" value="Siti Aminah">
										</div>

										<div class="col-md-6">
											<label class="form-label">Email Address</label>
											<input type="email" class="form-control rounded-3"
												name="email" value="siti@example.com">
										</div>
										...
										<div class="col-12">
											...
											<textarea class="form-control rounded-3" rows="3"
												name="address"
												placeholder="Enter staff address"></textarea>
										</div>
										...
										<div class="col-12">
											<div class="form-check form-switch">
												<input class="form-check-input" type="checkbox"
													name="transactionAlerts" id="transactionAlerts" checked>
												<label class="form-check-label" for="transactionAlerts">
													Receive transaction and AI advisory notifications
												</label>
											</div>
										</div>
